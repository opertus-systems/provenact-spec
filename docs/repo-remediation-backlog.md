...
Date: 2026-02-07
Scope: `inactu-agent-kit`, `inactu-cli`, `inactu-control`, `inactu-control-web`, `inactu-examples`, `inactu-sdk`, `inactu-skills`, `inactu-spec`.
...
- Severity: P0
- Owner repo(s): `inactu-cli`, `inactu-spec`
...
### P0-2: Fix broken `inactu-agent-kit` unit contract
- Severity: P0
- Owner repo(s): `inactu-agent-kit`
...
- Severity: P1
- Owner repo(s): `inactu-sdk`, `inactu-control`, `inactu-skills`, `inactu-cli`
- Finding: `inactu-skills` pin differs from `inactu-sdk`/`inactu-control`; "tested" claims are inconsistent cross-repo.
- PR checklist:
...
- Severity: P1
- Owner repo(s): `inactu-control-web`
...
2. Add missing docs in `inactu-agent-kit`, `inactu-control-web`, `inactu-examples`, `inactu-spec`.
...
- Severity: P2
- Owner repo(s): `inactu-control-web`, `inactu-control`, `inactu-cli`, `inactu-spec`
- Finding: mixed references to historical `opertus-systems/inactu` paths.
- PR checklist:
...
- Severity: P2
- Owner repo(s): `inactu-control`, `inactu-control-web`
- Finding: backend binary named `inactu-control-web` causes role confusion.
- PR checklist:
